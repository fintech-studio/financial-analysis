...
import { NewspaperIcon, MagnifyingGlassIcon, ArrowPathIcon } from "@heroicons/react/24/outline";
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-16 space-y-6">
                ...
                <div className="text-center">
                  <p className="text-xl font-semibold text-gray-700 mb-2">載入中...</p>
                    ...
                    >
                      ...
                      <div className="relative flex items-start gap-4">
                        <div className="flex-shrink-0 mt-1">
                          <div className="w-3 h-3 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 shadow-lg group-hover:scale-125 transition-transform duration-300"></div>
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <span className="text-sm text-gray-500">{article.pubDate}</span>
                          </div>
                          <a
                            href={article.link}
                            target="_blank"
