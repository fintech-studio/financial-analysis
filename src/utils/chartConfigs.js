...
// 市值分布圖表配置
export const marketCapChartOptions = {
  responsive: true,
  maintainAspectRatio: false,
  plugins: {
    legend: {
...
// 影響因素圖表配置
export const factorChartOptions = {
  responsive: true,
  maintainAspectRatio: false,
  plugins: {
    legend: {
...
// 產生價格圖表數據
export const generatePriceChartData = (historyData) => {
  return {
...
// 產生成交量圖表數據
export const generateVolumeChartData = (historyData) => {
  return {
    labels: historyData.labels,
    datasets: [
      {
...
// 產生RSI圖表數據
export const generateRsiChartData = (historyData) => {
  return {
    labels: historyData.labels,
    datasets: [
      {
...
// 產生市值圖表數據
export const generateMarketCapChartData = (coins) => {
  return {
...
// 產生影響因素圖表數據
export const generateFactorChartData = (factors) => {
  return {
...
// 產生價格和成交量組合圖表數據
export const generateCombinedChartData = (historyData, coin = "BTC") => {
