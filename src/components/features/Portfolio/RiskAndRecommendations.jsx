...
const RiskAndRecommendations = ({ riskData, aiData }) => {
  const [activeSection, setActiveSection] = useState("analysis"); // analysis, recommendations
