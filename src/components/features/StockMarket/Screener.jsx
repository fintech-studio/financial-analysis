...
const Screener = ({ favoriteStocks = [], toggleFavoriteStock }) => {
  // 主要狀態管理
  ...
  const [techFilters, setTechFilters] = useState({
    ...
    rsiMax: "",
    pattern: "all", // 技術形態
    macdSignal: "all", // MACD訊號
    bollingerPosition: "all", // 布林通道位置
    volumeChange: "all", // 成交量變化
  });
  ...
  const sortedResults = useMemo(() => {
    ...
    return [...screenResults].sort((a, b) => {
      ...
      // 處理數字字符串（如：成交量）
      if (typeof aValue === "string" && aValue.endsWith("億")) {
        aValue = parseFloat(aValue) * 100000000;
        bValue = parseFloat(bValue) * 100000000;
      }
